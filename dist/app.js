...
$(document).ready(function () {
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      loadArtistsInSelect(data); // stampa nella pagina HTML tutti gli album presenti nell'argomento data
  ...
  $(".select-artist").change(function () {
    var artist = $(".select-artist").val(); // chiamata ajax per recuperare dati del db filtrati per artista
...
function renderAlbum(albums) {
  ...
  for (var i = 0; i < albums.length; i++) {
    ...
    var html = template(context); // inietta nel DOM il codice Html, appendendolo al div elenco album
...
function loadArtistsInSelect(album) {
  ...
  var arraySelect = []; // ciclo per caricare i nomi artisti nella select
  ...
  for (var i = 0; i < album.length; i++) {
    ...
    if (!arraySelect.includes(album[i].author)) {
      ...
      arraySelect.push(album[i].author); // aggiunge il nome artista alla select
...
__webpack_require__(/*! D:\boolean_esercizi\php-ajax-dischi\src\app.js */"./src/app.js");
module.exports = __webpack_require__(/*! D:\boolean_esercizi\php-ajax-dischi\src\app.scss */"./src/app.scss");
